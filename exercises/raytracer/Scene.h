...
public:
    ...
    Scene() {
        ...
        spheres[0].center = glm::vec3(10.f, 0.f, -50.f);
        ...
        spheres[2].material.color = glm::vec3(1);
        spheres[2].material.diffuseReflectance = 8;
        spheres[2].material.metalness = 0.8f;
        spheres[2].material.roughness = 0.1f;
        ...
        for (int i = 4; i < 14; ++i)
        {
            ...
            spheres[i].material.ambientLightColor = glm::vec3(1.f, 1.f, 1.f);
            if(i <= 3) spheres[i].material = MaterialHelper::getMetalMaterial();
            else if (i == 5) spheres[i].material = MaterialHelper::getGlassMaterial();
            else spheres[i].material = MaterialHelper::getNormalMaterial();
            spheres[i].center = glm::vec3(1.f);
        }
